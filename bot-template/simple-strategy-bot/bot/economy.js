 ...
 *   88 兵才建指挥所（建完剩 38，喂养十几兵内即升冠），指挥所只是
 *   通往皇冠的短暂中间态，绝不让它长期趴着占兵。
 *
 * 唯一的限制是安全与节奏：
...
// 新建指挥所常规门槛 88：指挥所不增产（与普通格同速），唯一价值是升级
// 皇冠的中间态与连通锚点，因此攒到「建完剩 38、十几兵内即可升冠」才建——
// 对外表现为「直接新建皇冠」，而不是让指挥所长期趴着占兵。
// 开局补第二锚点（连通保险）放宽到 52。
const BUILD_CITY_MIN_ARMY = 88;
