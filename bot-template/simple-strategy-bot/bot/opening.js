/**
 * opening.js — 开局发育规划器（约 tick 1–30，issue #37 由 1–50 收缩）。
 *
 ...
 *
 * 退出条件：turn > 30、主城丢失、任何活跃威胁、或活敌逼近我方领土
...
// 开局窗口（issue #37 平衡性）：原覆盖整个爆发期（1–50），模拟最优开局的
// 滚雪球效应在开阔地形（随机图）偏强——1v1 胜率约 60%。收缩到 1–30，爆发期
// 后半交还常规管线的局部贪心扩张，全局最优蛇形节奏不再贯穿整场爆发期。
const OPENING_END_TURN = 30;
